...
public class imageSwitcher extends Activity implements OnItemSelectedListener, ViewFactory{
	...
	public static Integer[] mImageIds = {R.drawable.background1,R.drawable.background2}; 	
...
//	TypedArray icons = res.obtainTypedArray(R.array.imageBackground);
//	
//
//	public final Drawable[] mImageIds ={ (icons.getDrawable(1)),
//			icons.getDrawable(1)};
}
