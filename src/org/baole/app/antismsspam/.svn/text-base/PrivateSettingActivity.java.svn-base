...
public class PrivateSettingActivity extends ListActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle inState) {
		...
		setContentView(R.layout.private_setting_setting);
	...
	private void selectAContact(int pos) {
		...
		if (cursor != null) {
			ContactEntry ceContact = new ContactEntry(cursor.getString(5),
					cursor.getString(3));
			ArrayList<ContactEntry> contacts = mConf.mPrivateBlacklist.contacts;
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		mConf.mPrivateKeywords.loadPrefString(mEditKeywords.getText()
				.toString());
	...
	public void onClick(View v) {
		...
		case R.id.btnRemove:
			...
			mConf.mPrivateBlacklist.contacts.remove(ce);
			showBlackList();
			break;
		}
	}
	...
	private void showConfiguration() {
		mEditKeywords.setText(mConf.mPrivateKeywords.toPrefString());
		showBlackList();
	}

	private void showBlackList() {
		AntiSpamNumber adapter = new AntiSpamNumber(this,
				mConf.mPrivateBlacklist.contacts);
	...
	public class AntiSpamNumber extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.mRemove.setOnClickListener(PrivateSettingActivity.this);
