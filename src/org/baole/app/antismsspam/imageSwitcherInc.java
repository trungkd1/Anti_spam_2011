...
public class imageSwitcherInc extends Activity implements OnItemSelectedListener, ViewFactory{
	...
	public static Integer[] mImageIds = {R.drawable.inc1,R.drawable.inc2}; 	
